...
import com.socks.jiandan.okhttp.parser.PictureParser;
...
public class PictureAdapter extends RecyclerView.Adapter<PictureAdapter.PictureViewHolder> {
    ...
    private void loadData() {
        ...
        OkHttpProxy.get(Picture.getRequestUrl(mType, page), mActivity, new OkHttpCallback<ArrayList<Picture>>(new PictureParser()) {

            @Override
            public void onSuccess(int code, ArrayList<Picture> pictures) {
