...
import com.socks.jiandan.okhttp.parser.CommentCountsParser;
import com.socks.jiandan.okhttp.parser.JokeParser;
...
public class JokeAdapter extends RecyclerView.Adapter<JokeAdapter.JokeViewHolder> {
    ...
    private void loadData() {
        ...
        OkHttpProxy.get(Joke.getRequestUrl(page), mActivity, new OkHttpCallback<ArrayList<Joke>>(new JokeParser()) {

            @Override
            public void onSuccess(int code, ArrayList<Joke> jokes) {
    ...
    private void getCommentCounts(final ArrayList<Joke> jokes) {
        ...
        OkHttpProxy.get(CommentNumber.getCommentCountsURL(url), mActivity, new OkHttpCallback<ArrayList<CommentNumber>>(new CommentCountsParser()) {
            @Override
            public void onFailure(int code, String msg) {
            ...
            @Override
            public void onSuccess(int code, ArrayList<CommentNumber> response) {
